...
Guang
[LeetCode](https://leetcode.com/problems/integer-break/description/) 用的数学方法  int b = n % 3;  这时b 只能为 0  1   2 
```
class Solution {
...
Guang
[LeetCode](https://leetcode.com/problems/perfect-squares/description/) dp[i] = Math.min(dp[i], dp[i - j*j] + 1);  j*j 是平方数 j从1开始
```
class Solution {
